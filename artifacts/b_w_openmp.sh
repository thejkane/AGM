...
export LIBCDS_INSTALL=/home/users/p02119/software/pbgl2/boost/external/pq/cds/cds-1.6.0
...
-DCMAKE_EXE_LINKER_FLAGS:STRING="/home/users/p02119/software/pbgl2/boost/external/pq/cds/cds-1.6.0/bin/gcc-amd64-linux-0/libcds.so -lnuma" \
-DLIBNBC_LIBRARY:FILEPATH=$LIBCDS_INSTALL/bin/gcc-amd64-linux-0/libcds.so \
-DAM++_INCLUDE_DIR:PATH=$AMPP_INSTALL/include \
-DLIBNBC_INCLUDE_DIR= \
-DCMAKE_CXX_FLAGS:STRING="-std=c++11 -ggdb -DAMPLUSPLUS_BUILTIN_ATOMICS -UDC_USE_PRIORITY -UDC_USE_EXPLICIT_POLLING -UDC_USE_HANDLERS_PENDING -UDC_USE_AGGRESSIVE_PRIORITY -UDC_USE_POLL_ONCE -fopenmp -fsanitize=address" \
