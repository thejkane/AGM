...
#ifndef BOOST_GRAPH_DELTA_STEPPING_SHORTEST_PATHS_THREAD_HPP
#define BOOST_GRAPH_DELTA_STEPPING_SHORTEST_PATHS_THREAD_HPP
...
class delta_stepping_shortest_paths_thread {
  typedef delta_stepping_shortest_paths_thread<Graph, DistanceMap, EdgeWeightMap, PriorityQueueGenerator> 
    self_type;
...
public:
  ...
  delta_stepping_shortest_paths_thread(Graph& g,
  ...
  typedef std::tuple<unsigned long long, unsigned long long, unsigned long long> work_stats_t;
  work_stats_t
  get_work_stats() {
...
#define DELTA_STEPPING_SHORTEST_PATHS_THREAD_PARMS                                   \
...
#define DELTA_STEPPING_SHORTEST_PATHS_THREAD_TYPE                                    \
      delta_stepping_shortest_paths_thread<Graph, DistanceMap, EdgeWeightMap, WorkStats, PriorityQueueGenerator, MessageGenerator>

template<DELTA_STEPPING_SHORTEST_PATHS_THREAD_PARMS>
void
DELTA_STEPPING_SHORTEST_PATHS_THREAD_TYPE::initialize()
{
...
template<DELTA_STEPPING_SHORTEST_PATHS_THREAD_PARMS>
void
DELTA_STEPPING_SHORTEST_PATHS_THREAD_TYPE::run(Vertex s, int tid) {
  /**
...
template<DELTA_STEPPING_SHORTEST_PATHS_THREAD_PARMS>
void
DELTA_STEPPING_SHORTEST_PATHS_THREAD_TYPE::relax(const vertex_distance_data& vd) 
{
  Vertex v = vd.first;
  Dist d = vd.second;
...
template<DELTA_STEPPING_SHORTEST_PATHS_THREAD_PARMS>
void
DELTA_STEPPING_SHORTEST_PATHS_THREAD_TYPE::find_next_bucket()
{
  using boost::parallel::all_reduce;
...
template<DELTA_STEPPING_SHORTEST_PATHS_THREAD_PARMS>
struct DELTA_STEPPING_SHORTEST_PATHS_THREAD_TYPE::
vertex_distance_handler {
  
  vertex_distance_handler() : self(NULL) {}
  vertex_distance_handler(delta_stepping_shortest_paths_thread& self) : self(&self) {}
...
protected:
  delta_stepping_shortest_paths_thread* self;
};
