...
class AGMPageRankChaoticExecutor : public AGMPRBaseExecutor {
...
int main(int argc, char* argv[]) {
  ...
  executor<AGMPageRankChaoticExecutor, agm_params, agm_instance_params> agm_executor;
