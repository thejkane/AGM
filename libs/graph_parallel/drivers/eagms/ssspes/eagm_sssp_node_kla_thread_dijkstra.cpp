...
class AGMSSSPNodeKLAThreadDijkstraExecutor : public AGMSSSPBaseExecutor {
...
int main(int argc, char* argv[]) {
  ...
  executor<AGMSSSPNodeKLAThreadDijkstraExecutor, agm_params, agm_instance_params> agm_executor;
