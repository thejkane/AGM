...
class AGMSSSPNodeDeltaThreadExecutor : public AGMSSSPBaseExecutor {
...
int main(int argc, char* argv[]) {
  ...
  executor<AGMSSSPNodeDeltaThreadExecutor, agm_params, agm_instance_params> agm_executor;
