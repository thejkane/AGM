...
class AGMMISChaoticExecutor : public AGMMISBaseExecutor {
...
int main(int argc, char* argv[]) {
  ...
  executor<AGMMISChaoticExecutor, agm_params, agm_instance_params> agm_executor;
