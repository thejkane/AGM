#ifndef __EAGM_MIS_BASE__
#define __EAGM_MIS_BASE__
...
#include <boost/graph/agm/algorithms/mis.hpp>
...
protected:
  ...
  time_type execute_with_eagm_config(Graph& g, 
    ...
    boost::graph::agm::mis_family<Graph, IdDistribution> cces;    
