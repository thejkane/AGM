  ...
  get_instance_params() {
	...
	assert(false);
      ...
      BOOST_FOREACH (uint64_t s, sources) {
        agm_instance_params ainst(threads, s, verify);
...
class AGMChaoticThreadExecutor {
...
int main(int argc, char* argv[]) {
  ...
  executor<AGMChaoticThreadExecutor, agm_params, agm_instance_params> agm_executor;
