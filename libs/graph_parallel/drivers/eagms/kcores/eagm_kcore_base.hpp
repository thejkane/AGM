...
#include <boost/graph/agm/algorithms/kcore.hpp>
...
protected:
  ...
  time_type execute_with_eagm_config(Graph& g, 
    ...
    boost::graph::agm::kcore_family<Graph> kcores;    
